...
export default function EditModal({
  ...
  const handleSaveChanges = (e: React.SubmitEvent) => {
    e.preventDefault()
      ...
      >
        <div>
          ...
          <p className="text-heading-m mx-6 mt-6.5 md:mx-14 lg:leading-8">
            Edit <span className="text-07">#</span>
            {invoice.id}
          </p>
        </div>
        ...
        >
          ...
          <div className="card-shadow flex items-center justify-end gap-1.75 pt-5.25 pr-6 pb-5.5 md:bg-transparent md:py-7.75 dark:bg-03 md:dark:bg-transparent">
            ...
            <button
              type="submit"
              className="variant-heading-s h-12 w-full max-w-34.5 cursor-pointer rounded-[24px] bg-01 text-white hover:bg-02"
            >
              Save Changes
            </button>
          </div>
